...
@push('scripts')
    ...
    {{-- FreeCAD конфигуратор для центральной панели --}}
    <script type="module" src="{{ asset('js/pages/configurator-freecad.js') }}"></script>
    
    {{-- Главный модуль конфигуратора (старый, пока не удаляем) --}}
