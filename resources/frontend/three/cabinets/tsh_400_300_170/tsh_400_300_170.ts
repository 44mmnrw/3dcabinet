...
export class tsh_400_300_170 extends CabinetBase {
    ...
    async assemble(options: AssembleOptions = {}): Promise<THREE.Group> {
        ...
        try {
            ...
            console.log('✅ Шкаф tsh_400_300_170 собран успешно');
            console.log('📦 Компоненты:', Object.keys(this.components));
            return this.assembly;
        } catch (error) {
            console.error('❌ Ошибка сборки tsh_400_300_170:', error);
            throw error;
        }
    }
