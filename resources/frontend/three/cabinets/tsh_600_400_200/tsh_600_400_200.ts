...
export class tsh_600_400_200 extends CabinetBase {
    ...
    async assemble(options: AssembleOptions = {}): Promise<THREE.Group> {
        ...
        try {
            ...
            console.log('✅ Шкаф tsh_600_400_200 собран успешно');
            console.log('📦 Компоненты:', Object.keys(this.components));
            return this.assembly;
        } catch (error) {
            console.error('❌ Ошибка сборки tsh_600_400_200:', error);
            throw error;
        }
    }
