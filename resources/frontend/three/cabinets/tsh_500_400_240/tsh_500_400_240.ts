...
export class tsh_500_400_240 extends CabinetBase {
    ...
    async assemble(options: AssembleOptions = {}): Promise<THREE.Group> {
        ...
        try {
            ...
            console.log('✅ Шкаф tsh_500_400_240 собран успешно');
            console.log('📦 Компоненты:', Object.keys(this.components));
            return this.assembly;
        } catch (error) {
            console.error('❌ Ошибка сборки tsh_500_400_240:', error);
            throw error;
        }
    }
