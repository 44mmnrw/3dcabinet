...
export const EQUIPMENT_CATALOG: EquipmentConfig[] = [
    {
 ...
 */
export function getEquipmentByCategory(category: string): EquipmentConfig[] {
 ...
 */
export function getDinRailEquipment(): EquipmentConfig[] {
 ...
 */
export function getAvailableEquipment(): EquipmentConfig[] {
...
export const EQUIPMENT_CATEGORIES: Record<string, EquipmentCategoryInfo> = {
    protection: {
        name: 'Защита',
        icon: 'shield',
        color: '#FF9800'
