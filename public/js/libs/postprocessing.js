...
import { LinearFilter, SRGBColorSpace, UnsignedByteType, WebGLRenderTarget as WebGLRenderTarget2 } from "./three.module.js";
...
import { LinearSRGBColorSpace } from "./three.module.js";
...
import { BackSide, DoubleSide, FrontSide, ShaderMaterial as ShaderMaterial2 } from "./three.module.js";
...
import { EventDispatcher, Vector2 as Vector22 } from "./three.module.js";
var AUTO_SIZE = -1;
...
import { EventDispatcher as EventDispatcher2, Uniform as Uniform2 } from "./three.module.js";
...
import { Color as Color2, Uniform as Uniform3, Vector2 as Vector23, Vector4 } from "./three.module.js";

// src/textures/ASCIITexture.js
import { CanvasTexture, RepeatWrapping } from "./three.module.js";
...
import { SRGBColorSpace as SRGBColorSpace5, Uniform as Uniform8, WebGLRenderTarget as WebGLRenderTarget8 } from "./three.module.js";
...
import { SRGBColorSpace as SRGBColorSpace3, UnsignedByteType as UnsignedByteType3, WebGLRenderTarget as WebGLRenderTarget5 } from "./three.module.js";

// src/materials/KawaseBlurMaterial.js
import { NoBlending as NoBlending2, ShaderMaterial as ShaderMaterial3, Uniform as Uniform4, Vector4 as Vector42 } from "./three.module.js";
...
import { UnsignedByteType as UnsignedByteType4, WebGLRenderTarget as WebGLRenderTarget6 } from "./three.module.js";

// src/materials/LuminanceMaterial.js
import { NoBlending as NoBlending3, REVISION, ShaderMaterial as ShaderMaterial4, Uniform as Uniform5 } from "./three.module.js";
...
import { SRGBColorSpace as SRGBColorSpace4, UnsignedByteType as UnsignedByteType5, Vector2 as Vector26, WebGLRenderTarget as WebGLRenderTarget7 } from "./three.module.js";

// src/materials/DownsamplingMaterial.js
import { NoBlending as NoBlending4, ShaderMaterial as ShaderMaterial5, Uniform as Uniform6, Vector2 as Vector24 } from "./three.module.js";
...
import { NoBlending as NoBlending5, ShaderMaterial as ShaderMaterial6, Uniform as Uniform7, Vector2 as Vector25 } from "./three.module.js";
...
import { Uniform as Uniform9 } from "./three.module.js";
...
import { SRGBColorSpace as SRGBColorSpace6, Uniform as Uniform10 } from "./three.module.js";
...
import { Uniform as Uniform11 } from "./three.module.js";
...
import { Uniform as Uniform12, Vector2 as Vector27 } from "./three.module.js";
...
import { BasicDepthPacking as BasicDepthPacking4, SRGBColorSpace as SRGBColorSpace7, Uniform as Uniform16, UnsignedByteType as UnsignedByteType8, WebGLRenderTarget as WebGLRenderTarget9 } from "./three.module.js";
...
import { NoBlending as NoBlending6, ShaderMaterial as ShaderMaterial7, Uniform as Uniform13, Vector2 as Vector28 } from "./three.module.js";
...
import { BasicDepthPacking as BasicDepthPacking3, NoBlending as NoBlending7, PerspectiveCamera, ShaderMaterial as ShaderMaterial8, Uniform as Uniform14 } from "./three.module.js";
...
import { NoBlending as NoBlending8, ShaderMaterial as ShaderMaterial9, Uniform as Uniform15, UnsignedByteType as UnsignedByteType6 } from "./three.module.js";
...
import { UnsignedByteType as UnsignedByteType7 } from "./three.module.js";
...
import { Uniform as Uniform17, Vector2 as Vector29 } from "./three.module.js";
...
import { Uniform as Uniform18 } from "./three.module.js";
...
import { NearestFilter, RepeatWrapping as RepeatWrapping2, RGBAFormat as RGBAFormat2, Uniform as Uniform19, Vector2 as Vector210 } from "./three.module.js";
...
import { NoBlending as NoBlending10, ShaderMaterial as ShaderMaterial11, Uniform as Uniform21 } from "./three.module.js";
...
import { Uniform as Uniform23, Vector2 as Vector213 } from "./three.module.js";
...
import { Uniform as Uniform24, Vector3 as Vector32 } from "./three.module.js";
...
import { Uniform as Uniform25, Vector2 as Vector214 } from "./three.module.js";
...
import { FloatType, HalfFloatType, Uniform as Uniform26 } from "./three.module.js";
...
import { Color as Color6, RepeatWrapping as RepeatWrapping3, Uniform as Uniform30, UnsignedByteType as UnsignedByteType11, WebGLRenderTarget as WebGLRenderTarget12 } from "./three.module.js";

// src/materials/DepthComparisonMaterial.js
import { NoBlending as NoBlending11, PerspectiveCamera as PerspectiveCamera3, RGBADepthPacking, ShaderMaterial as ShaderMaterial12, Uniform as Uniform28 } from "./three.module.js";
...
import { NoBlending as NoBlending12, ShaderMaterial as ShaderMaterial13, Uniform as Uniform29, Vector2 as Vector215 } from "./three.module.js";
...
import { Color as Color5, MeshDepthMaterial, NearestFilter as NearestFilter3, RGBADepthPacking as RGBADepthPacking2, WebGLRenderTarget as WebGLRenderTarget11 } from "./three.module.js";
...
import { Uniform as Uniform31, Vector2 as Vector216, Vector4 as Vector43 } from "./three.module.js";
...
import { Uniform as Uniform32, Vector4 as Vector44 } from "./three.module.js";
...
import { Uniform as Uniform33, Vector2 as Vector217 } from "./three.module.js";
...
import { Uniform as Uniform34, Vector2 as Vector218, Vector3 as Vector35 } from "./three.module.js";
...
import { Uniform as Uniform35, Vector3 as Vector36 } from "./three.module.js";
...
import { BasicDepthPacking as BasicDepthPacking8, NoBlending as NoBlending13, REVISION as REVISION2, ShaderMaterial as ShaderMaterial14, Uniform as Uniform36, Vector2 as Vector219 } from "./three.module.js";
...
import { NoBlending as NoBlending14, ShaderMaterial as ShaderMaterial15, Uniform as Uniform37, Vector2 as Vector220 } from "./three.module.js";
...
import { BasicDepthPacking as BasicDepthPacking13, Color as Color9, RepeatWrapping as RepeatWrapping4, RGBAFormat as RGBAFormat4, Uniform as Uniform41, WebGLRenderTarget as WebGLRenderTarget16 } from "./three.module.js";

// src/materials/SSAOMaterial.js
import { BasicDepthPacking as BasicDepthPacking10, Matrix4 as Matrix42, NoBlending as NoBlending15, PerspectiveCamera as PerspectiveCamera4, ShaderMaterial as ShaderMaterial16, Uniform as Uniform39, Vector2 as Vector221 } from "./three.module.js";
...
import { BasicDepthPacking as BasicDepthPacking12, FloatType as FloatType4, NearestFilter as NearestFilter5, WebGLRenderTarget as WebGLRenderTarget15 } from "./three.module.js";

// src/materials/DepthDownsamplingMaterial.js
import { BasicDepthPacking as BasicDepthPacking11, NoBlending as NoBlending16, ShaderMaterial as ShaderMaterial17, Uniform as Uniform40, Vector2 as Vector222 } from "./three.module.js";
...
import { Uniform as Uniform42, UnsignedByteType as UnsignedByteType12 } from "./three.module.js";
...
import { SRGBColorSpace as SRGBColorSpace12, Uniform as Uniform44, Vector2 as Vector224, WebGLRenderTarget as WebGLRenderTarget17 } from "./three.module.js";

// src/materials/TiltShiftBlurMaterial.js
import { Uniform as Uniform43, Vector2 as Vector223, Vector4 as Vector45 } from "./three.module.js";
...
import { LinearMipmapLinearFilter, REVISION as REVISION3, Uniform as Uniform46, WebGLRenderTarget as WebGLRenderTarget19 } from "./three.module.js";

// src/passes/AdaptiveLuminancePass.js
import { NearestFilter as NearestFilter6, WebGLRenderTarget as WebGLRenderTarget18 } from "./three.module.js";

// src/materials/AdaptiveLuminanceMaterial.js
import { NoBlending as NoBlending17, ShaderMaterial as ShaderMaterial18, Uniform as Uniform45 } from "./three.module.js";
...
import { Uniform as Uniform47 } from "./three.module.js";
...
import { FileLoader, Loader, LoadingManager as LoadingManager2 } from "./three.module.js";
...
import { FileLoader as FileLoader2, Loader as Loader2, LoadingManager as LoadingManager3, Vector3 as Vector37 } from "./three.module.js";
...
import { NoBlending as NoBlending18, PerspectiveCamera as PerspectiveCamera5, ShaderMaterial as ShaderMaterial19, Uniform as Uniform48, Vector2 as Vector225 } from "./three.module.js";
...
import { BasicDepthPacking as BasicDepthPacking14, NoBlending as NoBlending19, ShaderMaterial as ShaderMaterial20, Uniform as Uniform49, Vector2 as Vector226 } from "./three.module.js";
...
import { BasicDepthPacking as BasicDepthPacking15, NoBlending as NoBlending20, PerspectiveCamera as PerspectiveCamera6, REVISION as REVISION4, ShaderMaterial as ShaderMaterial21, Uniform as Uniform50, Vector2 as Vector227 } from "./three.module.js";
...
import { NoBlending as NoBlending21, ShaderMaterial as ShaderMaterial22, Uniform as Uniform51, Vector2 as Vector228 } from "./three.module.js";
...
import { BasicDepthPacking as BasicDepthPacking16, SRGBColorSpace as SRGBColorSpace13, UnsignedByteType as UnsignedByteType13, WebGLRenderTarget as WebGLRenderTarget20 } from "./three.module.js";
...
import { BasicDepthPacking as BasicDepthPacking18, FloatType as FloatType6, REVISION as REVISION5, RGBADepthPacking as RGBADepthPacking5 } from "./three.module.js";
...
import { BasicDepthPacking as BasicDepthPacking19, NoColorSpace as NoColorSpace2, SRGBColorSpace as SRGBColorSpace14, UnsignedByteType as UnsignedByteType15 } from "./three.module.js";
...
import { SRGBColorSpace as SRGBColorSpace15, UnsignedByteType as UnsignedByteType16, WebGLRenderTarget as WebGLRenderTarget22 } from "./three.module.js";
...
import { Color as Color10, MeshNormalMaterial, NearestFilter as NearestFilter8, WebGLRenderTarget as WebGLRenderTarget23 } from "./three.module.js";
...
import { LoadingManager as LoadingManager5 } from "./three.module.js";
